...
def train(config, model_cls=HNNCL):
    ...
    #logger = init_logger(log_dir) #error
    ...
    for split_id, datamodule in enumerate(cv_spliter):
        ...
        #print(model.state_dict()['short_embedding.weight'])
...
def parse(print_help=False):
    ...
    parser.add_argument("--model", default="HNNCL", type=str)
    parser.add_argument("--epochs", default=800, type=int)#800
    ...
    parser = HNNCL.add_model_specific_args(parser)
